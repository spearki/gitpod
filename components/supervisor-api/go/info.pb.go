...
type WorkspaceInfoResponse_WorkspaceClass struct {
	...
	Powerups uint32 `protobuf:"varint,5,opt,name=powerups,proto3" json:"powerups,omitempty"`
...
func (x *WorkspaceInfoResponse_WorkspaceClass) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *WorkspaceInfoResponse_WorkspaceClass) GetPowerups() uint32 {
	if x != nil {
		return x.Powerups
	}
	return 0
...
func (x *WorkspaceInfoResponse_WorkspaceClass) GetIsDefault() bool {
	if x != nil {
		return x.IsDefault
	}
	return false
...
var file_info_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xc4,
	...
	0x1a, 0xbc, 0x01, 0x0a, 0x0e, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x43, 0x6c,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x6f, 0x77, 0x65, 0x72, 0x75, 0x70, 0x73,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x70, 0x6f, 0x77, 0x65, 0x72, 0x75, 0x70, 0x73,
	...
	0x14, 0x0a, 0x12, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x7f, 0x0a, 0x0b, 0x49, 0x6e, 0x66, 0x6f, 0x53, 0x65, 0x72,
